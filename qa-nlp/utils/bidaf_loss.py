...
def bidaf_loss(p_start, p_end, y_start, y_end):
    ...
    p_true_start = torch.gather(p_start, 1, y_start.unsqueeze(1).unsqueeze(2))  # equivalent to p_start[y_start]

    p_true_end = torch.gather(p_end, 1, y_end.unsqueeze(1).unsqueeze(2))  # equivalent to p_end[y_end]
